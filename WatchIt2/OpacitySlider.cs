...
namespace WatchIt2
{
    ...
    public class DoubleRibbonLayoutToggle : ToggleSettingsItem
    {
        private bool InProcess { get; set; }
        ...
        public override void Update()
        {
            ...
            if (Control != null && !InProcess && Control.Value != Settings.InformationPanelDoubleRibbonLayout)
                SetValue(Settings.InformationPanelDoubleRibbonLayout);
        }
        private void OnControlValueChanged(bool value)
        {
            if (InProcess)
            ...
            Settings.InformationPanelDoubleRibbonLayout.value = value;
            OnValueChanged?.Invoke(value);
        }
        private void SetValue(bool newValue)
        {
    ...
    public class GaugeOpacitySlider : ControlSettingsItem<CustomUISlider>
    {
        private CustomUILabel ValueLabel { get; set; }
        private bool InProcess { get; set; }
        ...
        protected override void InitControl()
        {
            Control.name = "Gauge opacity slider";
            Control.size = new Vector2(260f, 18f);
            Control.Orientation = UIOrientation.Horizontal;
            Control.MinValue = 0f;
            Control.MaxValue = 100f;
            ...
            ValueLabel = Content.AddUIComponent<CustomUILabel>();
            ValueLabel.name = "Gauge opacity value";
            ValueLabel.AutoSize = AutoSize.None;
            ValueLabel.size = new Vector2(46f, 18f);
            ValueLabel.textScale = 0.8f;
            ValueLabel.HorizontalAlignment = UIHorizontalAlignment.Right;
        ...
        public override void Update()
        {
            ...
            if (Control != null && !InProcess && value != Settings.InformationPanelGaugeOpacity.value)
                Value = Settings.InformationPanelGaugeOpacity.value;
        }
        private void OnSliderValueChanged(float sliderValue)
        {
            SetValue(Mathf.RoundToInt(sliderValue), true);
